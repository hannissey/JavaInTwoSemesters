...
public class Q4BankAccounts2 {
	...
	int index = search(myAccounts, accountNumberIn);
	...
	private static int search (BankAccount[] arrayIn, String valueIn) {
		for (int i = 0; i < arrayIn.length; i++) {
			BankAccount tempAccount = arrayIn[i];
			String tempNumber = tempAccount.getAccountNumber();
			if(tempNumber.equals(valueIn));
			{
