...
public class ComputerOrderSystem {
	public static void main(String[] args) {
		...
		if (response.equals("yes")) {
			...
			System.out.println("What size screen would you like? You can have 38 or 43 or 56 inches. Please type size.");
			...
			if (screenSize == 38) {
				...
				System.out.println("Wonderful! Our large 43 inch screen costs £99.99 ");
				totalCost = totalCost + screen43;
				System.out.println("We also have these optional extras available, a DVD/CD Writer and a printer. Are you interested? ");
				response = sc.nextLine();
				sc.nextLine();
				if (response.equals("yes")) {
					...
					sc.nextLine();
					if (response.equals("yes")) {
						System.out.println("I will add that to your package.");
						totalCost = totalCost + dvdCdWriter;
						System.out.println("Would you also like the printer? ");
						response = sc.nextLine();
						if (response.equals("yes")) {
							System.out.println("Great, the printer will be an additional " + printer);
							totalCost = totalCost + printer;
							...
							System.out.println("No problem at all. You have chosen our basic package, which is "
									+ basicSystem + " with the 38 inch screen at " + screen38 + ", and no additional extras. The total cost will be " + totalCost );
						}
						...
						if (response.equals("yes")) {
							totalCost = totalCost + printer;
							System.out.println("Great, the printer will be an additional £" + printer + ". You are purchasing our Basic System at £" + basicSystem + " with the 38 inch screen at " + screen38 + ", and a printer . The total cost will be " + totalCost);
						}
						else {
							System.out.println("No problem at all. You have chosen our basic system, which is "
									+ basicSystem + " with the 38 inch screen at " + screen38 + ", and no additional extras. The total cost will be " + totalCost );
			...
			System.out.println("No problem, hope to see you again soon! ");
		}
